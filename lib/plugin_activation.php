		...
		public function init() {
			...
			$this->strings = array(
				...
				'notice_can_install_required'     => _n_noop(
					'DanzerPress Plugin requires the following plugin: %1$s.',
					'DanzerPress Plugin requires the following plugins: %1$s.',
					'tgmpa'
				),
				/* translators: 1: plugin name(s). */
				'notice_can_install_recommended'  => _n_noop(
					'DanzerPress Plugin recommends the following plugin: %1$s.',
					'DanzerPress Plugin recommends the following plugins: %1$s.',
					'tgmpa'
				),
				/* translators: 1: plugin name(s). */
				'notice_ask_to_update'            => _n_noop(
					'The following plugin needs to be updated to its latest version to ensure maximum compatibility with DanzerPress Plugin: %1$s.',
					'The following plugins need to be updated to their latest version to ensure maximum compatibility with DanzerPress Plugin: %1$s.',
					'tgmpa'
				),
				/* translators: 1: plugin name(s). */
				...
				/* translators: 1: plugin name. */
				'plugin_needs_higher_version'     => __( 'Plugin not activated. A higher version of %s is needed for DanzerPress Plugin. Please update the plugin.', 'tgmpa' ),
